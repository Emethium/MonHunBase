...
public class Location {
	@Column
	private String map; // The name of the map the item is found. Ex : Flooded
						// Forest.
	@Column
	private String hunterRank; // I'm still not sure if I should add this.
	@Column
	private String mapArea; // The area, inside the map, the item is found. Ex :
							// Area 1,2,3.
	@Column
	private String gatheringMethod; // How you obtain the item. Ex : gathering,
									// mining.
